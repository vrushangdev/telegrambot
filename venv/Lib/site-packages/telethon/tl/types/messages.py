...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeMessage, TypeDocument, TypeStickerSet, TypeUser, TypeDialog, TypeHighScore, TypeEncryptedFile, TypeChat, TypeStickerSetCovered, TypeFoundGif, TypeChatFull, TypeBotInlineResult, TypeStickerPack
...
class ChannelMessages(TLObject):
    ...
    def __init__(self, pts, count, messages, chats, users, inexact=None):
        """
        :param int pts:
        :param int count:
        ...
        self.users = users  # type: List[TypeUser]
        self.inexact = inexact  # type: Optional[bool]
    ...
    def from_reader(cls, reader):
        ...
        return cls(pts=_pts, count=_count, messages=_messages, chats=_chats, users=_users, inexact=_inexact)
...
class MessagesSlice(TLObject):
    CONSTRUCTOR_ID = 0xa6c47aaa
    SUBCLASS_OF_ID = 0xd4b40b5e

    def __init__(self, count, messages, chats, users, inexact=None):
        """
        :param int count:
        :param List[TypeMessage] messages:
        :param List[TypeChat] chats:
    ...
    def from_reader(cls, reader):
        ...
        return cls(count=_count, messages=_messages, chats=_chats, users=_users, inexact=_inexact)
