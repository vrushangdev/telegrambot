...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeContact, TypeImportedContact, TypeContactBlocked, TypePopularContact, TypeUser, TypeChat, TypeTopPeerCategoryPeers, TypeContactLink
