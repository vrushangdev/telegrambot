...
class Authorization(TLObject):
    ...
    def __init__(self, hash, device_model, platform, system_version, api_id, app_name, app_version, date_created, date_active, ip, country, region, current=None, official_app=None, password_pending=None):
        """
        :param int hash:
        ...
        :param str country:
        :param str region:
        :param Optional[bool] current:
        :param Optional[bool] official_app:
        :param Optional[bool] password_pending:
        ...
        self.current = current  # type: Optional[bool]
        self.official_app = official_app  # type: Optional[bool]
        self.password_pending = password_pending  # type: Optional[bool]
...
class Channel(TLObject):
    CONSTRUCTOR_ID = 0x4df30834
    SUBCLASS_OF_ID = 0xc5af5d94

    def __init__(self, id, title, photo, date, version, creator=None, left=None, broadcast=None, verified=None, megagroup=None, restricted=None, signatures=None, min=None, access_hash=None, username=None, restriction_reason=None, admin_rights=None, banned_rights=None, default_banned_rights=None, participants_count=None):
        """
        :param int id:
        :param str title:
        ...
        :param Optional[TypeChatAdminRights] admin_rights:
        :param Optional[TypeChatBannedRights] banned_rights:
        :param Optional[TypeChatBannedRights] default_banned_rights:
        ...
        self.admin_rights = admin_rights  # type: Optional[TypeChatAdminRights]
        self.banned_rights = banned_rights  # type: Optional[TypeChatBannedRights]
        self.default_banned_rights = default_banned_rights  # type: Optional[TypeChatBannedRights]
...
class ChannelAdminLogEventActionDefaultBannedRights(TLObject):
    ...
    def __init__(self, prev_banned_rights, new_banned_rights):
        """
        :param TypeChatBannedRights prev_banned_rights:
        :param TypeChatBannedRights new_banned_rights:

        Constructor for ChannelAdminLogEventAction: Instance of either ChannelAdminLogEventActionChangeTitle, ChannelAdminLogEventActionChangeAbout, ChannelAdminLogEventActionChangeUsername, ChannelAdminLogEventActionChangePhoto, ChannelAdminLogEventActionToggleInvites, ChannelAdminLogEventActionToggleSignatures, ChannelAdminLogEventActionUpdatePinned, ChannelAdminLogEventActionEditMessage, ChannelAdminLogEventActionDeleteMessage, ChannelAdminLogEventActionParticipantJoin, ChannelAdminLogEventActionParticipantLeave, ChannelAdminLogEventActionParticipantInvite, ChannelAdminLogEventActionParticipantToggleBan, ChannelAdminLogEventActionParticipantToggleAdmin, ChannelAdminLogEventActionChangeStickerSet, ChannelAdminLogEventActionTogglePreHistoryHidden, ChannelAdminLogEventActionDefaultBannedRights, ChannelAdminLogEventActionStopPoll.
        """
        self.prev_banned_rights = prev_banned_rights  # type: TypeChatBannedRights
        self.new_banned_rights = new_banned_rights  # type: TypeChatBannedRights
...
class ChannelFull(TLObject):
    ...
    def __init__(self, id, about, read_inbox_max_id, read_outbox_max_id, unread_count, chat_photo, notify_settings, exported_invite, bot_info, can_view_participants=None, can_set_username=None, can_set_stickers=None, hidden_prehistory=None, can_view_stats=None, participants_count=None, admins_count=None, kicked_count=None, banned_count=None, online_count=None, migrated_from_chat_id=None, migrated_from_max_id=None, pinned_msg_id=None, stickerset=None, available_min_id=None):
        ...
        self.can_view_stats = can_view_stats  # type: Optional[bool]
        self.participants_count = participants_count  # type: Optional[int]
        ...
        self.online_count = online_count  # type: Optional[int]
    ...
    def __bytes__(self):
        ...
        return b''.join((
            b'\x1a\xa7\x87\x1c',
            struct.pack('<I', (0 if self.can_view_participants is None or self.can_view_participants is False else 8) | (0 if self.can_set_username is None or self.can_set_username is False else 64) | (0 if self.can_set_stickers is None or self.can_set_stickers is False else 128) | (0 if self.hidden_prehistory is None or self.hidden_prehistory is False else 1024) | (0 if self.can_view_stats is None or self.can_view_stats is False else 4096) | (0 if self.participants_count is None or self.participants_count is False else 1) | (0 if self.admins_count is None or self.admins_count is False else 2) | (0 if self.kicked_count is None or self.kicked_count is False else 4) | (0 if self.banned_count is None or self.banned_count is False else 4) | (0 if self.online_count is None or self.online_count is False else 8192) | (0 if self.migrated_from_chat_id is None or self.migrated_from_chat_id is False else 16) | (0 if self.migrated_from_max_id is None or self.migrated_from_max_id is False else 16) | (0 if self.pinned_msg_id is None or self.pinned_msg_id is False else 32) | (0 if self.stickerset is None or self.stickerset is False else 256) | (0 if self.available_min_id is None or self.available_min_id is False else 512)),
            struct.pack('<i', self.id),
    ...
    def from_reader(cls, reader):
        ...
        return cls(id=_id, about=_about, read_inbox_max_id=_read_inbox_max_id, read_outbox_max_id=_read_outbox_max_id, unread_count=_unread_count, chat_photo=_chat_photo, notify_settings=_notify_settings, exported_invite=_exported_invite, bot_info=_bot_info, can_view_participants=_can_view_participants, can_set_username=_can_set_username, can_set_stickers=_can_set_stickers, hidden_prehistory=_hidden_prehistory, can_view_stats=_can_view_stats, participants_count=_participants_count, admins_count=_admins_count, kicked_count=_kicked_count, banned_count=_banned_count, online_count=_online_count, migrated_from_chat_id=_migrated_from_chat_id, migrated_from_max_id=_migrated_from_max_id, pinned_msg_id=_pinned_msg_id, stickerset=_stickerset, available_min_id=_available_min_id)
...
class ChannelParticipantAdmin(TLObject):
    CONSTRUCTOR_ID = 0x5daa6e23
    SUBCLASS_OF_ID = 0xd9c7fc18

    def __init__(self, user_id, promoted_by, date, admin_rights, can_edit=None, is_self=None, inviter_id=None):
        """
        :param int user_id:
        :param int promoted_by:
        :param Optional[datetime] date:
        :param TypeChatAdminRights admin_rights:
        :param Optional[bool] can_edit:
        :param Optional[bool] is_self:
        :param Optional[int] inviter_id:
        ...
        self.date = date  # type: Optional[datetime]
        self.admin_rights = admin_rights  # type: TypeChatAdminRights
        self.can_edit = can_edit  # type: Optional[bool]
        self.is_self = is_self  # type: Optional[bool]
        self.inviter_id = inviter_id  # type: Optional[int]
    ...
    def __bytes__(self):
        ...
        return b''.join((
            b'#n\xaa]',
            struct.pack('<I', (0 if self.can_edit is None or self.can_edit is False else 1) | (0 if self.is_self is None or self.is_self is False else 2) | (0 if self.inviter_id is None or self.inviter_id is False else 2)),
            struct.pack('<i', self.user_id),
    ...
    def from_reader(cls, reader):
        ...
        _date = reader.tgread_date()
        _admin_rights = reader.tgread_object()
        return cls(user_id=_user_id, promoted_by=_promoted_by, date=_date, admin_rights=_admin_rights, can_edit=_can_edit, is_self=_is_self, inviter_id=_inviter_id)
...
class ChannelParticipantBanned(TLObject):
    ...
    def __init__(self, user_id, kicked_by, date, banned_rights, left=None):
        ...
        :param int kicked_by:
        :param Optional[datetime] date:
        :param TypeChatBannedRights banned_rights:
        :param Optional[bool] left:
        ...
        self.date = date  # type: Optional[datetime]
        self.banned_rights = banned_rights  # type: TypeChatBannedRights
        self.left = left  # type: Optional[bool]
...
class Chat(TLObject):
    ...
    def __init__(self, id, title, photo, participants_count, date, version, creator=None, kicked=None, left=None, deactivated=None, migrated_to=None, admin_rights=None, default_banned_rights=None):
        """
        :param int id:
        :param str title:
        :param TypeChatPhoto photo:
...
class ChatAdminRights(TLObject):
    ...
    def __init__(self, change_info=None, post_messages=None, edit_messages=None, delete_messages=None, ban_users=None, invite_users=None, pin_messages=None, add_admins=None):
        """
...
class ChatBannedRights(TLObject):
    ...
    def __init__(self, until_date, view_messages=None, send_messages=None, send_media=None, send_stickers=None, send_gifs=None, send_games=None, send_inline=None, embed_links=None, send_polls=None, change_info=None, invite_users=None, pin_messages=None):
        """
        :param Optional[datetime] until_date:
        ...
        :param Optional[bool] send_polls:
        :param Optional[bool] change_info:
        :param Optional[bool] invite_users:
        :param Optional[bool] pin_messages:
        ...
        self.send_polls = send_polls  # type: Optional[bool]
        self.change_info = change_info  # type: Optional[bool]
        self.invite_users = invite_users  # type: Optional[bool]
        self.pin_messages = pin_messages  # type: Optional[bool]
...
class ChatFull(TLObject):
    CONSTRUCTOR_ID = 0x22a235da
    SUBCLASS_OF_ID = 0xd49a2697

    def __init__(self, id, about, participants, notify_settings, exported_invite, can_set_username=None, chat_photo=None, bot_info=None, pinned_msg_id=None):
        """
        :param int id:
        :param str about:
        ...
        :param TypeExportedChatInvite exported_invite:
        :param Optional[bool] can_set_username:
        :param Optional[TypePhoto] chat_photo:
        :param Optional[List[TypeBotInfo]] bot_info:
        :param Optional[int] pinned_msg_id:
        ...
        self.exported_invite = exported_invite  # type: TypeExportedChatInvite
        self.can_set_username = can_set_username  # type: Optional[bool]
        self.chat_photo = chat_photo  # type: Optional[TypePhoto]
        self.bot_info = bot_info  # type: Optional[List[TypeBotInfo]]
        self.pinned_msg_id = pinned_msg_id  # type: Optional[int]
    ...
    def __bytes__(self):
        return b''.join((
            b'\xda5\xa2"',
            struct.pack('<I', (0 if self.can_set_username is None or self.can_set_username is False else 128) | (0 if self.chat_photo is None or self.chat_photo is False else 4) | (0 if self.bot_info is None or self.bot_info is False else 8) | (0 if self.pinned_msg_id is None or self.pinned_msg_id is False else 64)),
            struct.pack('<i', self.id),
            self.serialize_bytes(self.about),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 64:
            ...
            _pinned_msg_id = None
        return cls(id=_id, about=_about, participants=_participants, notify_settings=_notify_settings, exported_invite=_exported_invite, can_set_username=_can_set_username, chat_photo=_chat_photo, bot_info=_bot_info, pinned_msg_id=_pinned_msg_id)
...
class CodeSettings(TLObject):
    CONSTRUCTOR_ID = 0x302f59f3
    SUBCLASS_OF_ID = 0x48edbc8a

    def __init__(self, allow_flashcall=None, current_number=None, app_hash_persistent=None, app_hash=None):
        """
        :param Optional[bool] allow_flashcall:
        :param Optional[bool] current_number:
        :param Optional[bool] app_hash_persistent:
        :param Optional[str] app_hash:

        Constructor for CodeSettings: Instance of CodeSettings.
        """
        self.allow_flashcall = allow_flashcall  # type: Optional[bool]
        self.current_number = current_number  # type: Optional[bool]
        self.app_hash_persistent = app_hash_persistent  # type: Optional[bool]
        self.app_hash = app_hash  # type: Optional[str]
    ...
    def to_dict(self):
        return {
            ...
            'app_hash_persistent': self.app_hash_persistent,
    ...
    def __bytes__(self):
        return b''.join((
            b'\xf3Y/0',
            struct.pack('<I', (0 if self.allow_flashcall is None or self.allow_flashcall is False else 1) | (0 if self.current_number is None or self.current_number is False else 2) | (0 if self.app_hash_persistent is None or self.app_hash_persistent is False else 4) | (0 if self.app_hash is None or self.app_hash is False else 8)),
            b'' if self.app_hash is None or self.app_hash is False else (self.serialize_bytes(self.app_hash)),
        ))
...
class Config(TLObject):
    ...
    def __init__(self, date, expires, test_mode, this_dc, dc_options, dc_txt_domain_name, chat_size_max, megagroup_size_max, forwarded_count_max, online_update_period_ms, offline_blur_timeout_ms, offline_idle_timeout_ms, online_cloud_timeout_ms, notify_cloud_delay_ms, notify_default_delay_ms, push_chat_period_ms, push_chat_limit, saved_gifs_limit, edit_time_limit, revoke_time_limit, revoke_pm_time_limit, rating_e_decay, stickers_recent_limit, stickers_faved_limit, channels_read_media_period, pinned_dialogs_count_max, call_receive_timeout_ms, call_ring_timeout_ms, call_connect_timeout_ms, call_packet_timeout_ms, me_url_prefix, caption_length_max, message_length_max, webfile_dc_id, phonecalls_enabled=None, default_p2p_contacts=None, preload_featured_stickers=None, ignore_phone_entities=None, revoke_pm_inbox=None, blocked_mode=None, pfs_enabled=None, tmp_sessions=None, autoupdate_url_prefix=None, gif_search_username=None, venue_search_username=None, img_search_username=None, static_maps_provider=None, suggested_lang_code=None, lang_pack_version=None, base_lang_pack_version=None):
        ...
        :param Optional[bool] pfs_enabled:
        ...
        :param Optional[int] base_lang_pack_version:
        ...
        self.pfs_enabled = pfs_enabled  # type: Optional[bool]
        ...
        self.base_lang_pack_version = base_lang_pack_version  # type: Optional[int]
...
class Document(TLObject):
    ...
    def __init__(self, id, access_hash, file_reference, date, mime_type, size, dc_id, attributes, thumbs=None):
        """
        :param int id:
        :param int access_hash:
        :param bytes file_reference:
        :param Optional[datetime] date:
        :param str mime_type:
        :param int size:
        :param int dc_id:
        :param List[TypeDocumentAttribute] attributes:
        :param Optional[List[TypePhotoSize]] thumbs:

        Constructor for Document: Instance of either DocumentEmpty, Document.
        """
        self.id = id  # type: int
        self.access_hash = access_hash  # type: int
        self.file_reference = file_reference  # type: bytes
        self.date = date  # type: Optional[datetime]
        self.mime_type = mime_type  # type: str
        self.size = size  # type: int
        self.dc_id = dc_id  # type: int
        self.attributes = attributes  # type: List[TypeDocumentAttribute]
        self.thumbs = thumbs  # type: Optional[List[TypePhotoSize]]
...
class FileLocation(TLObject):
    CONSTRUCTOR_ID = 0x91d11eb
    SUBCLASS_OF_ID = 0x90f76823

    def __init__(self, dc_id, volume_id, local_id, secret, file_reference):
        """
        :param int dc_id:
        :param int volume_id:
        :param int local_id:
    ...
    def from_reader(cls, reader):
        ...
        _file_reference = reader.tgread_bytes()
        return cls(dc_id=_dc_id, volume_id=_volume_id, local_id=_local_id, secret=_secret, file_reference=_file_reference)
...
class InputAppEvent(TLObject):
    ...
    def __init__(self, time, type, peer, data):
        ...
        self.data = data  # type: TypeJSONValue
...
class InputCheckPasswordSRP(TLObject):
    ...
    def __init__(self, srp_id, A, M1):
        ...
        """
        self.srp_id = srp_id  # type: int
        self.A = A  # type: bytes
        self.M1 = M1  # type: bytes
...
class InputFileLocation(TLObject):
    ...
    def __init__(self, volume_id, local_id, secret, file_reference):
        """
        :param int volume_id:
        :param int local_id:
        :param int secret:
...
class InputMediaGeoLive(TLObject):
    ...
    def __init__(self, geo_point, stopped=None, period=None):
        """
        :param TypeInputGeoPoint geo_point:
        :param Optional[bool] stopped:
        :param Optional[int] period:

        Constructor for InputMedia: Instance of either InputMediaEmpty, InputMediaUploadedPhoto, InputMediaPhoto, InputMediaGeoPoint, InputMediaContact, InputMediaUploadedDocument, InputMediaDocument, InputMediaVenue, InputMediaGifExternal, InputMediaPhotoExternal, InputMediaDocumentExternal, InputMediaGame, InputMediaInvoice, InputMediaGeoLive, InputMediaPoll.
        """
        self.geo_point = geo_point  # type: TypeInputGeoPoint
        self.stopped = stopped  # type: Optional[bool]
        self.period = period  # type: Optional[int]
...
class InputReportReasonOther(TLObject):
    ...
    def __init__(self, text):
        ...
        Constructor for ReportReason: Instance of either InputReportReasonSpam, InputReportReasonViolence, InputReportReasonPornography, InputReportReasonChildAbuse, InputReportReasonOther, InputReportReasonCopyright.
        """
        self.text = text  # type: str
...
class InputSecureValue(TLObject):
    ...
    def __init__(self, type, data=None, front_side=None, reverse_side=None, selfie=None, translation=None, files=None, plain_data=None):
        """
        ...
        :param Optional[List[TypeInputSecureFile]] translation:
        ...
        self.translation = translation  # type: Optional[List[TypeInputSecureFile]]
...
class JsonBool(TLObject):
    ...
    def __init__(self, value):
        """
        :param TypeBool value:

        Constructor for JSONValue: Instance of either JsonNull, JsonBool, JsonNumber, JsonString, JsonArray, JsonObject.
        """
        self.value = value  # type: TypeBool
...
class JsonNumber(TLObject):
    ...
    def __init__(self, value):
        """
        :param Typedouble value:

        Constructor for JSONValue: Instance of either JsonNull, JsonBool, JsonNumber, JsonString, JsonArray, JsonObject.
        """
        self.value = value  # type: Typedouble
...
class JsonObject(TLObject):
    ...
    def __init__(self, value):
        """
        :param List[TypeJSONObjectValue] value:

        Constructor for JSONValue: Instance of either JsonNull, JsonBool, JsonNumber, JsonString, JsonArray, JsonObject.
        """
        self.value = value  # type: List[TypeJSONObjectValue]
...
class LangPackLanguage(TLObject):
    ...
    def __init__(self, name, native_name, lang_code, plural_code, strings_count, translated_count, translations_url, official=None, rtl=None, beta=None, base_lang_code=None):
        """
        :param str name:
        :param str native_name:
        :param str lang_code:
        :param str plural_code:
        :param int strings_count:
        :param int translated_count:
        :param str translations_url:
        :param Optional[bool] official:
        :param Optional[bool] rtl:
        :param Optional[bool] beta:
        :param Optional[str] base_lang_code:
        ...
        self.lang_code = lang_code  # type: str
        self.plural_code = plural_code  # type: str
        self.strings_count = strings_count  # type: int
        self.translated_count = translated_count  # type: int
        self.translations_url = translations_url  # type: str
        self.official = official  # type: Optional[bool]
        self.rtl = rtl  # type: Optional[bool]
        self.beta = beta  # type: Optional[bool]
        self.base_lang_code = base_lang_code  # type: Optional[str]
...
class MessageMediaPoll(TLObject):
    ...
    def __init__(self, poll, results):
        """
        :param TypePoll poll:
        :param TypePollResults results:

        Constructor for MessageMedia: Instance of either MessageMediaEmpty, MessageMediaPhoto, MessageMediaGeo, MessageMediaContact, MessageMediaUnsupported, MessageMediaDocument, MessageMediaWebPage, MessageMediaVenue, MessageMediaGame, MessageMediaInvoice, MessageMediaGeoLive, MessageMediaPoll.
        """
        self.poll = poll  # type: TypePoll
        self.results = results  # type: TypePollResults
...
class PQInnerDataTempDc(TLObject):
    ...
    def __init__(self, pq, p, q, nonce, server_nonce, new_nonce, dc, expires_in):
        """
        :param bytes pq:
        :param bytes p:
        :param bytes q:
...
class Page(TLObject):
    ...
    def __init__(self, url, blocks, photos, documents, part=None, rtl=None, v2=None):
        """
        :param str url:
        :param List[TypePageBlock] blocks:
        :param List[TypePhoto] photos:
        :param List[TypeDocument] documents:
        :param Optional[bool] part:
        :param Optional[bool] rtl:
        :param Optional[bool] v2:
        ...
        self.part = part  # type: Optional[bool]
        self.rtl = rtl  # type: Optional[bool]
        self.v2 = v2  # type: Optional[bool]
...
class PageBlockAudio(TLObject):
    ...
    def __init__(self, audio_id, caption):
        """
        :param int audio_id:
        :param TypePageCaption caption:

        Constructor for PageBlock: Instance of either PageBlockUnsupported, PageBlockTitle, PageBlockSubtitle, PageBlockAuthorDate, PageBlockHeader, PageBlockSubheader, PageBlockParagraph, PageBlockPreformatted, PageBlockFooter, PageBlockDivider, PageBlockAnchor, PageBlockList, PageBlockBlockquote, PageBlockPullquote, PageBlockPhoto, PageBlockVideo, PageBlockCover, PageBlockEmbed, PageBlockEmbedPost, PageBlockCollage, PageBlockSlideshow, PageBlockChannel, PageBlockAudio, PageBlockKicker, PageBlockTable, PageBlockOrderedList, PageBlockDetails, PageBlockRelatedArticles, PageBlockMap.
        """
        self.audio_id = audio_id  # type: int
        self.caption = caption  # type: TypePageCaption
...
class PageBlockDetails(TLObject):
    ...
    def __init__(self, blocks, title, open=None):
        """
        :param List[TypePageBlock] blocks:
        :param TypeRichText title:
        :param Optional[bool] open:

        Constructor for PageBlock: Instance of either PageBlockUnsupported, PageBlockTitle, PageBlockSubtitle, PageBlockAuthorDate, PageBlockHeader, PageBlockSubheader, PageBlockParagraph, PageBlockPreformatted, PageBlockFooter, PageBlockDivider, PageBlockAnchor, PageBlockList, PageBlockBlockquote, PageBlockPullquote, PageBlockPhoto, PageBlockVideo, PageBlockCover, PageBlockEmbed, PageBlockEmbedPost, PageBlockCollage, PageBlockSlideshow, PageBlockChannel, PageBlockAudio, PageBlockKicker, PageBlockTable, PageBlockOrderedList, PageBlockDetails, PageBlockRelatedArticles, PageBlockMap.
        """
        self.blocks = blocks  # type: List[TypePageBlock]
        self.title = title  # type: TypeRichText
        self.open = open  # type: Optional[bool]
...
class PageBlockEmbed(TLObject):
    ...
    def __init__(self, caption, full_width=None, allow_scrolling=None, url=None, html=None, poster_photo_id=None, w=None, h=None):
        """
        :param TypePageCaption caption:
        ...
        :param Optional[int] w:
        :param Optional[int] h:
...
class PageBlockList(TLObject):
    ...
    def __init__(self, items):
        """
        :param List[TypePageListItem] items:

        Constructor for PageBlock: Instance of either PageBlockUnsupported, PageBlockTitle, PageBlockSubtitle, PageBlockAuthorDate, PageBlockHeader, PageBlockSubheader, PageBlockParagraph, PageBlockPreformatted, PageBlockFooter, PageBlockDivider, PageBlockAnchor, PageBlockList, PageBlockBlockquote, PageBlockPullquote, PageBlockPhoto, PageBlockVideo, PageBlockCover, PageBlockEmbed, PageBlockEmbedPost, PageBlockCollage, PageBlockSlideshow, PageBlockChannel, PageBlockAudio, PageBlockKicker, PageBlockTable, PageBlockOrderedList, PageBlockDetails, PageBlockRelatedArticles, PageBlockMap.
        """
        self.items = items  # type: List[TypePageListItem]
...
class PageBlockMap(TLObject):
    ...
    def __init__(self, geo, zoom, w, h, caption):
        """
        :param TypeGeoPoint geo:
        :param int zoom:
        :param int w:
...
class PageBlockOrderedList(TLObject):
    ...
    def __init__(self, items):
        """
        :param List[TypePageListOrderedItem] items:

        Constructor for PageBlock: Instance of either PageBlockUnsupported, PageBlockTitle, PageBlockSubtitle, PageBlockAuthorDate, PageBlockHeader, PageBlockSubheader, PageBlockParagraph, PageBlockPreformatted, PageBlockFooter, PageBlockDivider, PageBlockAnchor, PageBlockList, PageBlockBlockquote, PageBlockPullquote, PageBlockPhoto, PageBlockVideo, PageBlockCover, PageBlockEmbed, PageBlockEmbedPost, PageBlockCollage, PageBlockSlideshow, PageBlockChannel, PageBlockAudio, PageBlockKicker, PageBlockTable, PageBlockOrderedList, PageBlockDetails, PageBlockRelatedArticles, PageBlockMap.
        """
        self.items = items  # type: List[TypePageListOrderedItem]
...
class PageBlockPhoto(TLObject):
    ...
    def __init__(self, photo_id, caption, url=None, webpage_id=None):
        """
        :param int photo_id:
        :param TypePageCaption caption:
        :param Optional[str] url:
        :param Optional[int] webpage_id:
        ...
        self.caption = caption  # type: TypePageCaption
        self.url = url  # type: Optional[str]
        self.webpage_id = webpage_id  # type: Optional[int]
...
class PageBlockRelatedArticles(TLObject):
    ...
    def __init__(self, title, articles):
        """
        :param TypeRichText title:
        :param List[TypePageRelatedArticle] articles:

        Constructor for PageBlock: Instance of either PageBlockUnsupported, PageBlockTitle, PageBlockSubtitle, PageBlockAuthorDate, PageBlockHeader, PageBlockSubheader, PageBlockParagraph, PageBlockPreformatted, PageBlockFooter, PageBlockDivider, PageBlockAnchor, PageBlockList, PageBlockBlockquote, PageBlockPullquote, PageBlockPhoto, PageBlockVideo, PageBlockCover, PageBlockEmbed, PageBlockEmbedPost, PageBlockCollage, PageBlockSlideshow, PageBlockChannel, PageBlockAudio, PageBlockKicker, PageBlockTable, PageBlockOrderedList, PageBlockDetails, PageBlockRelatedArticles, PageBlockMap.
        """
        self.title = title  # type: TypeRichText
        self.articles = articles  # type: List[TypePageRelatedArticle]
...
class PageBlockTable(TLObject):
    ...
    def __init__(self, title, rows, bordered=None, striped=None):
        """
        :param TypeRichText title:
        :param List[TypePageTableRow] rows:
        :param Optional[bool] bordered:
        :param Optional[bool] striped:

        Constructor for PageBlock: Instance of either PageBlockUnsupported, PageBlockTitle, PageBlockSubtitle, PageBlockAuthorDate, PageBlockHeader, PageBlockSubheader, PageBlockParagraph, PageBlockPreformatted, PageBlockFooter, PageBlockDivider, PageBlockAnchor, PageBlockList, PageBlockBlockquote, PageBlockPullquote, PageBlockPhoto, PageBlockVideo, PageBlockCover, PageBlockEmbed, PageBlockEmbedPost, PageBlockCollage, PageBlockSlideshow, PageBlockChannel, PageBlockAudio, PageBlockKicker, PageBlockTable, PageBlockOrderedList, PageBlockDetails, PageBlockRelatedArticles, PageBlockMap.
        """
        self.title = title  # type: TypeRichText
        self.rows = rows  # type: List[TypePageTableRow]
        self.bordered = bordered  # type: Optional[bool]
        self.striped = striped  # type: Optional[bool]
...
class PageCaption(TLObject):
    ...
    def __init__(self, text, credit):
        """
        :param TypeRichText text:
        :param TypeRichText credit:

        Constructor for PageCaption: Instance of PageCaption.
        """
        self.text = text  # type: TypeRichText
        self.credit = credit  # type: TypeRichText
...
class PageRelatedArticle(TLObject):
    ...
    def __init__(self, url, webpage_id, title=None, description=None, photo_id=None, author=None, published_date=None):
        """
        :param str url:
        :param int webpage_id:
        :param Optional[str] title:
        :param Optional[str] description:
        :param Optional[int] photo_id:
        ...
        self.title = title  # type: Optional[str]
        self.description = description  # type: Optional[str]
        self.photo_id = photo_id  # type: Optional[int]
...
class PageTableCell(TLObject):
    ...
    def __init__(self, header=None, align_center=None, align_right=None, valign_middle=None, valign_bottom=None, text=None, colspan=None, rowspan=None):
        """
        :param Optional[bool] header:
        :param Optional[bool] align_center:
        :param Optional[bool] align_right:
        :param Optional[bool] valign_middle:
        :param Optional[bool] valign_bottom:
        :param Optional[TypeRichText] text:
        :param Optional[int] colspan:
        :param Optional[int] rowspan:

        Constructor for PageTableCell: Instance of PageTableCell.
        """
        self.header = header  # type: Optional[bool]
        self.align_center = align_center  # type: Optional[bool]
        self.align_right = align_right  # type: Optional[bool]
        self.valign_middle = valign_middle  # type: Optional[bool]
        self.valign_bottom = valign_bottom  # type: Optional[bool]
        self.text = text  # type: Optional[TypeRichText]
        self.colspan = colspan  # type: Optional[int]
        self.rowspan = rowspan  # type: Optional[int]
...
class PageTableRow(TLObject):
    ...
    def __init__(self, cells):
        """
        :param List[TypePageTableCell] cells:

        Constructor for PageTableRow: Instance of PageTableRow.
        """
        self.cells = cells  # type: List[TypePageTableCell]
...
class PasswordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow(TLObject):
    ...
    def __init__(self, salt1, salt2, g, p):
        """
        :param bytes salt1:
        :param bytes salt2:
        :param int g:
        ...
        """
        self.salt1 = salt1  # type: bytes
        self.salt2 = salt2  # type: bytes
        self.g = g  # type: int
        self.p = p  # type: bytes
...
class PhoneCall(TLObject):
    CONSTRUCTOR_ID = 0xe6f9ddf3
    SUBCLASS_OF_ID = 0xc47f1bd1

    def __init__(self, id, access_hash, date, admin_id, participant_id, g_a_or_b, key_fingerprint, protocol, connection, alternative_connections, start_date, p2p_allowed=None):
        """
        :param int id:
        :param int access_hash:
        :param Optional[datetime] date:
        ...
        :param Optional[bool] p2p_allowed:
        ...
        self.p2p_allowed = p2p_allowed  # type: Optional[bool]
    ...
    def to_dict(self):
        return {
            ...
            'alternative_connections': [] if self.alternative_connections is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.alternative_connections],
    ...
    def from_reader(cls, reader):
        ...
        return cls(id=_id, access_hash=_access_hash, date=_date, admin_id=_admin_id, participant_id=_participant_id, g_a_or_b=_g_a_or_b, key_fingerprint=_key_fingerprint, protocol=_protocol, connection=_connection, alternative_connections=_alternative_connections, start_date=_start_date, p2p_allowed=_p2p_allowed)
...
class Photo(TLObject):
    CONSTRUCTOR_ID = 0x9c477dd8
    SUBCLASS_OF_ID = 0xd576ab1c

    def __init__(self, id, access_hash, file_reference, date, sizes, has_stickers=None):
        """
        :param int id:
        :param int access_hash:
        :param bytes file_reference:
    ...
    def from_reader(cls, reader):
        ...
        return cls(id=_id, access_hash=_access_hash, file_reference=_file_reference, date=_date, sizes=_sizes, has_stickers=_has_stickers)
...
class Poll(TLObject):
    ...
    def __init__(self, id, question, answers, closed=None):
        """
        :param int id:
        :param str question:
        :param List[TypePollAnswer] answers:
        :param Optional[bool] closed:

        Constructor for Poll: Instance of Poll.
        """
        self.id = id  # type: int
        self.question = question  # type: str
        self.answers = answers  # type: List[TypePollAnswer]
        self.closed = closed  # type: Optional[bool]
...
class PollAnswerVoters(TLObject):
    ...
    def __init__(self, option, voters, chosen=None):
        """
        :param bytes option:
        :param int voters:
        :param Optional[bool] chosen:

        Constructor for PollAnswerVoters: Instance of PollAnswerVoters.
        """
        self.option = option  # type: bytes
        self.voters = voters  # type: int
        self.chosen = chosen  # type: Optional[bool]
...
class PollResults(TLObject):
    ...
    def __init__(self, min=None, results=None, total_voters=None):
        """
        :param Optional[bool] min:
        :param Optional[List[TypePollAnswerVoters]] results:
        :param Optional[int] total_voters:

        Constructor for PollResults: Instance of PollResults.
        """
        self.min = min  # type: Optional[bool]
        self.results = results  # type: Optional[List[TypePollAnswerVoters]]
        self.total_voters = total_voters  # type: Optional[int]
...
class SecureRequiredType(TLObject):
    ...
    def __init__(self, type, native_names=None, selfie_required=None, translation_required=None):
        """
        :param TypeSecureValueType type:
        :param Optional[bool] native_names:
        :param Optional[bool] selfie_required:
        :param Optional[bool] translation_required:

        Constructor for SecureRequiredType: Instance of either SecureRequiredType, SecureRequiredTypeOneOf.
        """
        self.type = type  # type: TypeSecureValueType
        self.native_names = native_names  # type: Optional[bool]
        self.selfie_required = selfie_required  # type: Optional[bool]
        self.translation_required = translation_required  # type: Optional[bool]
...
class SecureRequiredTypeOneOf(TLObject):
    ...
    def __init__(self, types):
        """
        :param List[TypeSecureRequiredType] types:

        Constructor for SecureRequiredType: Instance of either SecureRequiredType, SecureRequiredTypeOneOf.
        """
        self.types = types  # type: List[TypeSecureRequiredType]
...
class SecureSecretSettings(TLObject):
    ...
    def __init__(self, secure_algo, secure_secret, secure_secret_id):
        """
        :param TypeSecurePasswordKdfAlgo secure_algo:
        :param bytes secure_secret:
        :param int secure_secret_id:

        Constructor for SecureSecretSettings: Instance of SecureSecretSettings.
        """
        self.secure_algo = secure_algo  # type: TypeSecurePasswordKdfAlgo
...
class SecureValue(TLObject):
    ...
    def __init__(self, type, hash, data=None, front_side=None, reverse_side=None, selfie=None, translation=None, files=None, plain_data=None):
        """
        :param TypeSecureValueType type:
        :param bytes hash:
        :param Optional[TypeSecureData] data:
        ...
        :param Optional[List[TypeSecureFile]] translation:
        ...
        self.translation = translation  # type: Optional[List[TypeSecureFile]]
...
class SecureValueError(TLObject):
    ...
    def __init__(self, type, hash, text):
        """
        :param TypeSecureValueType type:
        :param bytes hash:
        :param str text:
...
class TextImage(TLObject):
    ...
    def __init__(self, document_id, w, h):
        """
        ...
        Constructor for RichText: Instance of either TextEmpty, TextPlain, TextBold, TextItalic, TextUnderline, TextStrike, TextFixed, TextUrl, TextEmail, TextConcat, TextSubscript, TextSuperscript, TextMarked, TextPhone, TextImage, TextAnchor.
        """
        self.document_id = document_id  # type: int
        self.w = w  # type: int
        self.h = h  # type: int
...
class UpdateBotCallbackQuery(TLObject):
    ...
    def __init__(self, query_id, user_id, peer, msg_id, chat_instance, data=None, game_short_name=None):
        ...
        Constructor for Update: Instance of either UpdateNewMessage, UpdateMessageID, UpdateDeleteMessages, UpdateUserTyping, UpdateChatUserTyping, UpdateChatParticipants, UpdateUserStatus, UpdateUserName, UpdateUserPhoto, UpdateContactLink, UpdateNewEncryptedMessage, UpdateEncryptedChatTyping, UpdateEncryption, UpdateEncryptedMessagesRead, UpdateChatParticipantAdd, UpdateChatParticipantDelete, UpdateDcOptions, UpdateUserBlocked, UpdateNotifySettings, UpdateServiceNotification, UpdatePrivacy, UpdateUserPhone, UpdateReadHistoryInbox, UpdateReadHistoryOutbox, UpdateWebPage, UpdateReadMessagesContents, UpdateChannelTooLong, UpdateChannel, UpdateNewChannelMessage, UpdateReadChannelInbox, UpdateDeleteChannelMessages, UpdateChannelMessageViews, UpdateChatParticipantAdmin, UpdateNewStickerSet, UpdateStickerSetsOrder, UpdateStickerSets, UpdateSavedGifs, UpdateBotInlineQuery, UpdateBotInlineSend, UpdateEditChannelMessage, UpdateChannelPinnedMessage, UpdateBotCallbackQuery, UpdateEditMessage, UpdateInlineBotCallbackQuery, UpdateReadChannelOutbox, UpdateDraftMessage, UpdateReadFeaturedStickers, UpdateRecentStickers, UpdateConfig, UpdatePtsChanged, UpdateChannelWebPage, UpdateDialogPinned, UpdatePinnedDialogs, UpdateBotWebhookJSON, UpdateBotWebhookJSONQuery, UpdateBotShippingQuery, UpdateBotPrecheckoutQuery, UpdatePhoneCall, UpdateLangPackTooLong, UpdateLangPack, UpdateFavedStickers, UpdateChannelReadMessagesContents, UpdateContactsReset, UpdateChannelAvailableMessages, UpdateDialogUnreadMark, UpdateUserPinnedMessage, UpdateChatPinnedMessage, UpdateMessagePoll, UpdateChatDefaultBannedRights.
        """
...
class UpdateChatDefaultBannedRights(TLObject):
    ...
    def __init__(self, peer, default_banned_rights, version):
        """
        :param TypePeer peer:
        :param TypeChatBannedRights default_banned_rights:
        :param int version:

        Constructor for Update: Instance of either UpdateNewMessage, UpdateMessageID, UpdateDeleteMessages, UpdateUserTyping, UpdateChatUserTyping, UpdateChatParticipants, UpdateUserStatus, UpdateUserName, UpdateUserPhoto, UpdateContactLink, UpdateNewEncryptedMessage, UpdateEncryptedChatTyping, UpdateEncryption, UpdateEncryptedMessagesRead, UpdateChatParticipantAdd, UpdateChatParticipantDelete, UpdateDcOptions, UpdateUserBlocked, UpdateNotifySettings, UpdateServiceNotification, UpdatePrivacy, UpdateUserPhone, UpdateReadHistoryInbox, UpdateReadHistoryOutbox, UpdateWebPage, UpdateReadMessagesContents, UpdateChannelTooLong, UpdateChannel, UpdateNewChannelMessage, UpdateReadChannelInbox, UpdateDeleteChannelMessages, UpdateChannelMessageViews, UpdateChatParticipantAdmin, UpdateNewStickerSet, UpdateStickerSetsOrder, UpdateStickerSets, UpdateSavedGifs, UpdateBotInlineQuery, UpdateBotInlineSend, UpdateEditChannelMessage, UpdateChannelPinnedMessage, UpdateBotCallbackQuery, UpdateEditMessage, UpdateInlineBotCallbackQuery, UpdateReadChannelOutbox, UpdateDraftMessage, UpdateReadFeaturedStickers, UpdateRecentStickers, UpdateConfig, UpdatePtsChanged, UpdateChannelWebPage, UpdateDialogPinned, UpdatePinnedDialogs, UpdateBotWebhookJSON, UpdateBotWebhookJSONQuery, UpdateBotShippingQuery, UpdateBotPrecheckoutQuery, UpdatePhoneCall, UpdateLangPackTooLong, UpdateLangPack, UpdateFavedStickers, UpdateChannelReadMessagesContents, UpdateContactsReset, UpdateChannelAvailableMessages, UpdateDialogUnreadMark, UpdateUserPinnedMessage, UpdateChatPinnedMessage, UpdateMessagePoll, UpdateChatDefaultBannedRights.
        """
        self.peer = peer  # type: TypePeer
        self.default_banned_rights = default_banned_rights  # type: TypeChatBannedRights
        self.version = version  # type: int
...
class UpdateChatPinnedMessage(TLObject):
    ...
    def from_reader(cls, reader):
        _chat_id = reader.read_int()
        _id = reader.read_int()
        return cls(chat_id=_chat_id, id=_id)
...
class UpdateContactLink(TLObject):
    ...
    def to_dict(self):
        return {
            '_': 'UpdateContactLink',
            'user_id': self.user_id,
            'my_link': self.my_link.to_dict() if isinstance(self.my_link, TLObject) else self.my_link,
            'foreign_link': self.foreign_link.to_dict() if isinstance(self.foreign_link, TLObject) else self.foreign_link
        }
...
class UpdateMessagePoll(TLObject):
    ...
    def __init__(self, poll_id, results, poll=None):
        """
        :param int poll_id:
        :param TypePollResults results:
        :param Optional[TypePoll] poll:

        Constructor for Update: Instance of either UpdateNewMessage, UpdateMessageID, UpdateDeleteMessages, UpdateUserTyping, UpdateChatUserTyping, UpdateChatParticipants, UpdateUserStatus, UpdateUserName, UpdateUserPhoto, UpdateContactLink, UpdateNewEncryptedMessage, UpdateEncryptedChatTyping, UpdateEncryption, UpdateEncryptedMessagesRead, UpdateChatParticipantAdd, UpdateChatParticipantDelete, UpdateDcOptions, UpdateUserBlocked, UpdateNotifySettings, UpdateServiceNotification, UpdatePrivacy, UpdateUserPhone, UpdateReadHistoryInbox, UpdateReadHistoryOutbox, UpdateWebPage, UpdateReadMessagesContents, UpdateChannelTooLong, UpdateChannel, UpdateNewChannelMessage, UpdateReadChannelInbox, UpdateDeleteChannelMessages, UpdateChannelMessageViews, UpdateChatParticipantAdmin, UpdateNewStickerSet, UpdateStickerSetsOrder, UpdateStickerSets, UpdateSavedGifs, UpdateBotInlineQuery, UpdateBotInlineSend, UpdateEditChannelMessage, UpdateChannelPinnedMessage, UpdateBotCallbackQuery, UpdateEditMessage, UpdateInlineBotCallbackQuery, UpdateReadChannelOutbox, UpdateDraftMessage, UpdateReadFeaturedStickers, UpdateRecentStickers, UpdateConfig, UpdatePtsChanged, UpdateChannelWebPage, UpdateDialogPinned, UpdatePinnedDialogs, UpdateBotWebhookJSON, UpdateBotWebhookJSONQuery, UpdateBotShippingQuery, UpdateBotPrecheckoutQuery, UpdatePhoneCall, UpdateLangPackTooLong, UpdateLangPack, UpdateFavedStickers, UpdateChannelReadMessagesContents, UpdateContactsReset, UpdateChannelAvailableMessages, UpdateDialogUnreadMark, UpdateUserPinnedMessage, UpdateChatPinnedMessage, UpdateMessagePoll, UpdateChatDefaultBannedRights.
        """
        self.poll_id = poll_id  # type: int
        self.results = results  # type: TypePollResults
        self.poll = poll  # type: Optional[TypePoll]
...
class UserFull(TLObject):
    CONSTRUCTOR_ID = 0x8ea4a881
    SUBCLASS_OF_ID = 0x1f4661b9

    def __init__(self, user, link, notify_settings, common_chats_count, blocked=None, phone_calls_available=None, phone_calls_private=None, can_pin_message=None, about=None, profile_photo=None, bot_info=None, pinned_msg_id=None):
        """
        :param TypeUser user:
        :param TypeLink link:
        :param TypePeerNotifySettings notify_settings:
        ...
        :param Optional[bool] can_pin_message:
        ...
        self.can_pin_message = can_pin_message  # type: Optional[bool]
    ...
    def __bytes__(self):
        return b''.join((
            b'\x81\xa8\xa4\x8e',
            struct.pack('<I', (0 if self.blocked is None or self.blocked is False else 1) | (0 if self.phone_calls_available is None or self.phone_calls_available is False else 16) | (0 if self.phone_calls_private is None or self.phone_calls_private is False else 32) | (0 if self.can_pin_message is None or self.can_pin_message is False else 128) | (0 if self.about is None or self.about is False else 2) | (0 if self.profile_photo is None or self.profile_photo is False else 4) | (0 if self.bot_info is None or self.bot_info is False else 8) | (0 if self.pinned_msg_id is None or self.pinned_msg_id is False else 64)),
            bytes(self.user),
    ...
    def from_reader(cls, reader):
        ...
        return cls(user=_user, link=_link, notify_settings=_notify_settings, common_chats_count=_common_chats_count, blocked=_blocked, phone_calls_available=_phone_calls_available, phone_calls_private=_phone_calls_private, can_pin_message=_can_pin_message, about=_about, profile_photo=_profile_photo, bot_info=_bot_info, pinned_msg_id=_pinned_msg_id)
...
class WallPaper(TLObject):
    ...
    def __init__(self, id, access_hash, slug, document, creator=None, default=None, pattern=None, dark=None, settings=None):
        """
        :param int id:
        :param int access_hash:
        :param str slug:
        ...
        :param Optional[bool] pattern:
        :param Optional[bool] dark:
        :param Optional[TypeWallPaperSettings] settings:
        ...
        self.document = document  # type: TypeDocument
        self.creator = creator  # type: Optional[bool]
        self.default = default  # type: Optional[bool]
        self.pattern = pattern  # type: Optional[bool]
        self.dark = dark  # type: Optional[bool]
        self.settings = settings  # type: Optional[TypeWallPaperSettings]
...
class WallPaperSettings(TLObject):
    ...
    def __init__(self, blur=None, motion=None, background_color=None, intensity=None):
        """
        :param Optional[bool] blur:
        :param Optional[bool] motion:
        :param Optional[int] background_color:
        :param Optional[int] intensity:

        Constructor for WallPaperSettings: Instance of WallPaperSettings.
        """
        self.blur = blur  # type: Optional[bool]
        self.motion = motion  # type: Optional[bool]
        self.background_color = background_color  # type: Optional[int]
        self.intensity = intensity  # type: Optional[int]
...
TypeInputPrivacyKey = Union[InputPrivacyKeyStatusTimestamp,InputPrivacyKeyChatInvite,InputPrivacyKeyPhoneCall,InputPrivacyKeyPhoneP2P]
...
TypeReportReason = Union[InputReportReasonSpam,InputReportReasonViolence,InputReportReasonPornography,InputReportReasonChildAbuse,InputReportReasonOther,InputReportReasonCopyright]
...
TypePrivacyKey = Union[PrivacyKeyStatusTimestamp,PrivacyKeyChatInvite,PrivacyKeyPhoneCall,PrivacyKeyPhoneP2P]
