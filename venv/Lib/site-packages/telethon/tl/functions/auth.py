...
class CheckPasswordRequest(TLRequest):
    ...
    def __init__(self, password):
        """
        :param TypeInputCheckPasswordSRP password:

        :returns auth.Authorization: Instance of Authorization.
        """
        self.password = password  # type: TypeInputCheckPasswordSRP
...
class SendCodeRequest(TLRequest):
    ...
    def __init__(self, phone_number, api_id, api_hash, settings):
        """
        :param str phone_number:
        :param int api_id:
        :param str api_hash:
        :param TypeCodeSettings settings:
        ...
        self.api_id = api_id  # type: int
        self.api_hash = api_hash  # type: str
        self.settings = settings  # type: TypeCodeSettings
