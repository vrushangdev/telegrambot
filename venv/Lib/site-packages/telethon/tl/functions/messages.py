...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputGeoPoint, TypeInputEncryptedChat, TypeInputBotInlineMessageID, TypeInputChatPhoto, TypeInputEncryptedFile, TypeInputUser, TypeMessagesFilter, TypeInputDocument, TypeChatBannedRights, TypeInputMedia, TypeInlineBotSwitchPM, TypeInputStickerSet, TypeInputMessage, TypeInputDialogPeer, TypeShippingOption, TypeInputStickeredMedia, TypeReportReason, TypeInputSingleMedia, TypeMessageEntity, TypeBool, TypeInputPeer, TypeReplyMarkup, TypeSendMessageAction, TypeInputBotInlineResult
...
class EditChatDefaultBannedRightsRequest(TLRequest):
    ...
    def __init__(self, peer, banned_rights):
        """
        :param TypeInputPeer peer:
...
class EditInlineBotMessageRequest(TLRequest):
    ...
    def __init__(self, id, no_webpage=None, message=None, media=None, reply_markup=None, entities=None):
        """
...
class EditMessageRequest(TLRequest):
    CONSTRUCTOR_ID = 0xd116f31e
    SUBCLASS_OF_ID = 0x8af52aac

    def __init__(self, peer, id, no_webpage=None, message=None, media=None, reply_markup=None, entities=None):
        """
        :param TypeInputPeer peer:
        :param int id:
        :param Optional[bool] no_webpage:
    ...
    def from_reader(cls, reader):
        ...
        if flags & 8:
            ...
            _entities = None
        return cls(peer=_peer, id=_id, no_webpage=_no_webpage, message=_message, media=_media, reply_markup=_reply_markup, entities=_entities)
...
class SendInlineBotResultRequest(TLRequest):
    ...
    def __init__(self, peer, query_id, id, silent=None, background=None, clear_draft=None, hide_via=None, reply_to_msg_id=None, random_id=None):
        """
        :param TypeInputPeer peer:
        :param int query_id:
        :param str id:
        ...
        self.hide_via = hide_via  # type: Optional[bool]
        self.reply_to_msg_id = reply_to_msg_id  # type: Optional[int]
        self.random_id = random_id if random_id is not None else int.from_bytes(os.urandom(8), 'big', signed=True)
    ...
    def __bytes__(self):
        return b''.join((
            b'\xfe\x06n\xb1',
            struct.pack('<I', (0 if self.silent is None or self.silent is False else 32) | (0 if self.background is None or self.background is False else 64) | (0 if self.clear_draft is None or self.clear_draft is False else 128) | (0 if self.hide_via is None or self.hide_via is False else 2048) | (0 if self.reply_to_msg_id is None or self.reply_to_msg_id is False else 1)),
            bytes(self.peer),
            b'' if self.reply_to_msg_id is None or self.reply_to_msg_id is False else (struct.pack('<i', self.reply_to_msg_id)),
            struct.pack('<q', self.random_id),
    ...
    def from_reader(cls, reader):
        ...
        return cls(peer=_peer, query_id=_query_id, id=_id, silent=_silent, background=_background, clear_draft=_clear_draft, hide_via=_hide_via, reply_to_msg_id=_reply_to_msg_id, random_id=_random_id)
...
class SendVoteRequest(TLRequest):
    ...
    def __init__(self, peer, msg_id, options):
        """
        :param TypeInputPeer peer:
        :param int msg_id:
        :param List[bytes] options:

        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
        self.peer = peer  # type: TypeInputPeer
        self.msg_id = msg_id  # type: int
        self.options = options  # type: List[bytes]
...
class UpdatePinnedMessageRequest(TLRequest):
    ...
    def __init__(self, peer, id, silent=None):
        """
        :param TypeInputPeer peer:
        :param int id:
        :param Optional[bool] silent:
