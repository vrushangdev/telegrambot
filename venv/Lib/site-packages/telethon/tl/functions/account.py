...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeSecureValueHash, TypeCodeSettings, TypeInputCheckPasswordSRP, TypeInputWallPaper, TypeWallPaperSettings, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputFile, TypeInputNotifyPeer, TypeBool, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeInputSecureValue, TypeSecureValueType
...
class GetNotifyExceptionsRequest(TLRequest):
    ...
    def __init__(self, compare_sound=None, peer=None):
        """
        :param Optional[bool] compare_sound:
        :param Optional[TypeInputNotifyPeer] peer:

        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
        self.compare_sound = compare_sound  # type: Optional[bool]
        self.peer = peer  # type: Optional[TypeInputNotifyPeer]
    ...
    def __bytes__(self):
        return b''.join((
            ...
            b'' if self.peer is None or self.peer is False else (bytes(self.peer)),
        ))
...
class GetTmpPasswordRequest(TLRequest):
    ...
    def __init__(self, password, period):
        """
        :param TypeInputCheckPasswordSRP password:
        :param int period:
...
class GetWallPaperRequest(TLRequest):
    ...
    def __init__(self, wallpaper):
        """
        :param TypeInputWallPaper wallpaper:

        :returns WallPaper: Instance of WallPaper.
        """
        self.wallpaper = wallpaper  # type: TypeInputWallPaper
...
class InstallWallPaperRequest(TLRequest):
    ...
    def __init__(self, wallpaper, settings):
        """
        :param TypeInputWallPaper wallpaper:
        :param TypeWallPaperSettings settings:

        :returns Bool: This type has no constructors.
        """
        self.wallpaper = wallpaper  # type: TypeInputWallPaper
        self.settings = settings  # type: TypeWallPaperSettings
...
class SaveWallPaperRequest(TLRequest):
    ...
    def __init__(self, wallpaper, unsave, settings):
        """
        :param TypeInputWallPaper wallpaper:
...
class SendChangePhoneCodeRequest(TLRequest):
    ...
    def __init__(self, phone_number, settings):
        """
        :param str phone_number:
...
class SendConfirmPhoneCodeRequest(TLRequest):
    ...
    def __init__(self, hash, settings):
        """
        :param str hash:
        :param TypeCodeSettings settings:
...
class SetContactSignUpNotificationRequest(TLRequest):
    ...
    def __init__(self, silent):
        """
        :param TypeBool silent:

        :returns Bool: This type has no constructors.
        """
        self.silent = silent  # type: TypeBool
...
class UploadWallPaperRequest(TLRequest):
    ...
    def __init__(self, file, mime_type, settings):
        """
