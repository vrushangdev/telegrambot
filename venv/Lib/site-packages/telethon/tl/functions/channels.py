...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeChatAdminRights, TypeChannelAdminLogEventsFilter, TypeInputStickerSet, TypeInputMessage, TypeInputUser, TypeBool, TypeChatBannedRights, TypeInputChannel
