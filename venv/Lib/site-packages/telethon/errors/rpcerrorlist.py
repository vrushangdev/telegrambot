...
class ChatSendInlineForbiddenError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('You cannot send inline results in this chat' + self._fmt_request(request))
...
class EmailInvalidError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The given email is invalid' + self._fmt_request(request))
...
class EmoticonEmptyError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The emoticon field cannot be empty' + self._fmt_request(request))
...
class FreshResetAuthorisationForbiddenError(AuthKeyError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The current session is too new and cannot be used to reset other authorisations yet' + self._fmt_request(request))
...
class MaxQtsInvalidError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The provided QTS were invalid' + self._fmt_request(request))
...
class PasswordRequiredError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The account must have 2-factor authentication enabled (a password) before this method can be used' + self._fmt_request(request))
...
class PhotoInvalidDimensionsError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The photo dimensions are invalid (hint: `pip install pillow` for `send_file` to resize images)' + self._fmt_request(request))
...
class ResultIdDuplicateError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('Duplicated IDs on the sent results. Make sure to use unique IDs.' + self._fmt_request(request))
...
class ResultsTooMuchError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('You sent too many results. See https://core.telegram.org/bots/api#answerinlinequery for the current limit.' + self._fmt_request(request))
...
class UserInvalidError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The given user was invalid' + self._fmt_request(request))
...
class WallpaperFileInvalidError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The given file cannot be used as a wallpaper' + self._fmt_request(request))


class WallpaperInvalidError(BadRequestError):
    def __init__(self, request, **kwargs):
        super(Exception, self).__init__('The input wallpaper was not valid' + self._fmt_request(request))
